...
beta.groups <- c(0.005826891,0.003922071,0.007696104, #all cause 25
                 0.01133287,0.00861777,0.01397619, #cvd
                 0.00806579,0.007788654,0.008250122, #all cause 65
                 0.009531018,0.004879016,0.013976194) #cvd 65

names(beta.groups) <- c('Krewski et al. 2009, point estimate',
                        'Krewski et al. 2009, lower CI',
                        'Krewski et al. 2009, upper CI',
                        'Turner et al. 2016, point estimate',
                        'Turner et al. 2016, lower CI',
...
conc.groups <- c('conc.pm.mean.13.15','conc.med.pm.ho.13.15','conc.min.pm.ho.13.15','conc.vd.pm.2015','conc.med.vd.pm','conc.min.vd.pm')
names(conc.groups) <- c('Di et al. 2016','Di et al. 2016 median concentrations','Di et al. 2016 minimum concentrations',
                        'van Donkelaar et al. 2016','van Donkelaar et al. 2016 median concentrations', 'van Donkelaar et al. 2016 minimum concentrations')
