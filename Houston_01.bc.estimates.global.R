...
setwd('/GWSPH/home/vtinney/ho/results3/bc/')
library(raster)
library(rgdal)
library(dplyr)
library(ggplot2)
...
conc.groups <- c('bc.ho','med.bc.ho','min.bc.ho')
...
for (i in 1:length(beta.groups)){
  ...
  for (j in 1:length(conc.groups)){
    ...
    for (m in 1:length(clip.groups)){
      ...
      f1 = paste('/GWSPH/home/vtinney/ho/results3/bc/af/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),'.tif',sep='')
      ...
      f2 = paste('/GWSPH/home/vtinney/ho/results3/bc/mr/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,'.tif',sep='')
      ...
      f3 = paste('/GWSPH/home/vtinney/ho/results3/bc/paf/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,', ',pop.names,'.tif',sep='')
